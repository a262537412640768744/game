...
挑战目标： 5e76 本写好的作业<br>已完成<br>奖励：解锁最大期末考试
</button>` : EU[3] ? `
<button class="EC" onmousedown="clickEC(0)">
试卷挑战0：<br>你只有一个自动作业机<br>
挑战目标： 5e76 本写好的作业<br>点击这个按钮
...
挑战目标： 1e128 本写好的作业<br>已完成<br>奖励：作业机速度*写完的作业^(完成的挑战数/240)
</button>` : EC[1] ? `
<button class="EC" onmousedown="clickEC(2)">
试卷挑战2：<br>作业机效果^0.8，试卷效果^0.6，知识效果^0.5，升级1效果^0.4<br>
挑战目标： 1e128 本写好的作业<br>点击这个按钮
${currentChallenge == 2 ? (finishHomeworks.gte(1e128) ? "完成挑战" : "退出挑战") : "进入挑战"}
...
挑战目标： 3e60 本写好的作业<br>已完成<br>奖励：试卷获取量*2
</button>` : EC[2] ? `
<button class="EC" onmousedown="clickEC(3)">
试卷挑战3：<br>前三个挑战同时进行<br>
挑战目标： 3e60 本写好的作业<br>点击这个按钮
${currentChallenge == 3 ? (finishHomeworks.gte(3e60) ? "完成挑战" : "退出挑战") : "进入挑战"}
<br>奖励：试卷获取量*2
</button>` : ""
}
