...
，提升梦境生产速度*
${1}
</div><button class="G" onmousedown="">安装
${display(((sleepPoint.root(32).div(4).sub(3)).gte(0) ? sleepPoint.root(32).div(4).sub(3) : new D(0))
    )}
个游戏<br>但是重置前面的所有内容（保留1个睡眠点）<br>要求： 3.04e38 个睡眠点</button>`
}
