function toString(value, a = false) {
    ...
    if (value.layer === 0) {
        if (value.mag < 1e9 && value.mag > 1e-5 || value.mag === 0) {
            return (value.sign * value.mag).toFixed(a ? 0 : 2);
        }
...
function delete0(num, a = false) {
    return toString(num, a).replace(/((?<=\.[0-9]*)|\.)(0+)(?=e|$)/, "")
}

function display(num, a = false) {
    return delete0(num, a).replace(/((?<!.*\..*)|(?<=.*(e|F).*))(\d)(?=(\d\d\d)+(?!\d))/g, "$3,")
}
...
function EU4() {
    return EU[4] ? `
<button class="EU" style="background: #c0c000">
试卷升级4：<br>解锁睡眠<br>花费： 1e60 张写好的试卷
</button>` : EC[3] ? `
...
挑战目标： 2e92 本写好的作业<br>已完成<br>奖励：解锁最大期末考试
</button>` : EU[3] ? `
<button class="EC" onmousedown="clickEC(0)">
试卷挑战0：<br>你只有一个自动作业机<br>
挑战目标： 2e92 本写好的作业<br>点击这个按钮
${currentChallenge == 0 ? (finishHomeworks.gte(2e92) ? "完成挑战" : "退出挑战") : "进入挑战"}
<br>奖励：解锁最大期末考试
</button>` : ""
}
...
挑战目标： 3e64 本写好的作业<br>已完成<br>奖励：试卷获取量*2
</button>` : EC[2] ? `
<button class="EC" onmousedown="clickEC(3)">
试卷挑战3：<br>前三个挑战同时进行<br>
挑战目标： 3e64 本写好的作业<br>点击这个按钮
${currentChallenge == 3 ? (finishHomeworks.gte(3e64) ? "完成挑战" : "退出挑战") : "进入挑战"}
<br>奖励：试卷获取量*2
</button>` : ""
}
...
购买 1 个，需要花费${display(DPrice(1))}睡眠点</button></div><div class="D2">你有
...
购买 1 个，需要花费${display(DPrice(2))}睡眠点</button></div><div class="D3">你有
...
购买 1 个，需要花费${display(DPrice(3))}睡眠点</button></div>` : ""
}
...
日期：2024/7/21
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
EndGame：写完1e1200本作业（可以写2e60张试卷）
</div>
<div class="changelog">
版本v1.0.0：添加了重置层“睡眠”
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
日期：2024/7/26
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
EndGame：写完1e150000本作业
</div>
<div class="changelog">
版本v1.0.3：添加2个睡眠里程碑和梦境
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
日期：2024/7/27夜晚
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
EndGame：写完e1e10本作业
...
<div class="changelog">
版本v1.1.1：添加1个游戏里程碑，修改了一些显示，降低了一些难度
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
日期：2024/8/2
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
