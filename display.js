...
</button>` : EC[2] ? `<button class="EC" onmousedown="clickEC(3)">
试卷挑战3：<br>前三个挑战同时进行<br>
挑战目标： 3e64 本写好的作业<br>点击这个按钮
${currentChallenge == 3 ? (finishHomeworks.gte(1e154) ? "完成挑战" : "退出挑战") : "进入挑战"}
<br>奖励：试卷获取量*2
</button>` : ""
}
...
日期：2024/7/22夜晚
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
EndGame：写完1e10000本作业（可以写2e500张试卷）
</div>`
}
