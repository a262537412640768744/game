...
let price = () => machines
let sleepGain = () => examinationPapers.add(1).log(4).sqrt().div(4).sub(3)
let sleepPoint = new D(0)
let sleepSpeedup = () => (new D(4)).pow(sleepPoint.mul(2.25))
let sleepGainup = () => (new D(4)).pow(sleepPoint.mul(0.75))
